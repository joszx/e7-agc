from gear.substat import Substat 
import gear.gear_calc as gear_calc
...
class Gear:
    def __init__(self, gear_level, gear_type, enhance_level, substat_name_list, substat_value_list):
        ...
        if self.gear_level != gear_calc.LVL85 or self.enhance_level != 15:
    ...
    def __str__(self):
        ...
        for i in range(len(self.substat_list)):
            ...
            if self.gear_level == gear_calc.LVL85 and self.enhance_level == 15:
